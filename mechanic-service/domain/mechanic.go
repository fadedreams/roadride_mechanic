...
type OutboxEvent struct {
	...
	KafkaTopic     string     `bson:"kafka_topic" json:"kafka_topic"`
	KafkaPartition int32      `bson:"kafka_partition" json:"kafka_partition"`
	KafkaOffset    int64      `bson:"kafka_offset" json:"kafka_offset"`
}
